 ...
 <?php $project_name = "New Era"; ?>
<!DOCTYPE html>

<head>
<meta charset="utf-8">
<title><?php echo($project_name)?>Pattern Library</title>
<meta name="viewport" content="width=device-width">
<!-- Style Guide Boilerplate Styles -->
<!-- <link rel="stylesheet" href="assets/stylesheets/bootstrap.css"> -->
<link rel="stylesheet" href="compiled/css/nep-styles.css">
<link rel="stylesheet" href="compiled/css/style-guide.css">

<!-- Replace below stylesheet with your own stylesheet -->
<!-- <link rel="stylesheet" href="assets/stylesheets/gd-styles/css/theme.css"> -->
<!-- FONTS FROM TYPEKIT -->
<script src="//use.typekit.net/fpr3piv.js"></script>
...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
  <div class="container">
    <div class="navbar-header"> <a class="navbar-brand" href="#"><strong><?php echo($project_name)?></strong> Pattern Library</a> </div>
